...
4. PROGRESS TRACKING:
   - Use UpdatePlan to mark specific progress
...
1. STRUCTURED ANALYSIS:
   ...
   - Use CreatePlan or UpdatePlan to ensure structured approach
...
3. RESET AND RESTART:
   - Use UpdatePlan to revise the approach based on new understanding
