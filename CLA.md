# UCAgent Individual Contributor License Agreement ("Agreement")

Thank you for your interest in **UCAgent** (the "Project"). In order to clarify the intellectual property license granted with Contributions from any person or entity, the Project must have a Contributor License Agreement ("CLA") on file that has been agreed to by each Contributor.
