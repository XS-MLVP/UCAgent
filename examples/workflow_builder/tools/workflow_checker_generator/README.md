...
```bash
python -m examples.workflow_builder.tools.workflow_checker_generator.cli <workflow_root> \
...
```yaml
- examples.workflow_builder.tools.workflow_checker_generator.uc_tools.WorkflowCheckerGenerator
```
