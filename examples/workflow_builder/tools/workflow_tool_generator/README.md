...
```bash
python -m examples.workflow_builder.tools.workflow_tool_generator.cli <workflow_root> --tool run_command_tool
python -m examples.workflow_builder.tools.workflow_tool_generator.cli <workflow_root> \
...
```yaml
- examples.workflow_builder.tools.workflow_tool_generator.uc_tools.WorkflowToolGenerator
```
