...
```bash
python -m examples.workflow_builder.workflow_evaluation_control.cli --workspace "$WS" initialize
python -m examples.workflow_builder.workflow_evaluation_control.cli --workspace "$WS" validate
