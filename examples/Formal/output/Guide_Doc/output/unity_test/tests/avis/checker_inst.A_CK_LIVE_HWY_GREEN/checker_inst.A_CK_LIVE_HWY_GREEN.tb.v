...
initial begin
    ...
    clk <= 1'b1;
    #1;
    long_timer_value <= 5'b00011;
    #4;
    clk <= 1'b0;
    #5;
    clk <= 1'b1;
    #1;
    long_timer_value <= 5'b01100;
    short_timer_value <= 5'b00100;
    #4;
    clk <= 1'b0;
    #5;
    clk <= 1'b1;
