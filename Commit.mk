...
ALLOWED_PATHS := $(WORKFLOW_BUILDER_PATH) $(WORKFLOW_BUILDER_DOCS_PATH) $(DOCS_NAV_PATH) $(COMMIT_MAKEFILE_PATH)
...
verify: branch
	...
	outside="$$(printf '%s\n' "$$staged" | awk \
		...
		'$$0 == nav || $$0 == helper || index($$0, workflow) == 1 || index($$0, docs) == 1 { next } { print }')"; \
	if [[ -n "$$outside" ]]; then \
