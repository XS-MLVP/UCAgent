...
### 步骤1:阅读`reference_files`中列举的文件

### 步骤2:直接使用`RunSkillScript`工具执行`create_template.py`脚本,来创建所有的测试用例模板,不允许你自己写代码来创建测试用例模板

### 步骤3:直接使用`Complete`工具推进阶段,不要进行额外分析
