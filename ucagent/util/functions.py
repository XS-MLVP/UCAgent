...
def description_bug_doc():
    ...
    return [
        "[Dynamic Bug Analysis Contract] Follow the active stage task and Guide_Doc/dut_bug_analysis.md for the complete workflow. When the active stage enables dynamic-bug-recording and its script is available, maintain the Bug document only through that Skill's deterministic operations and ApplyWaveInfoEvidence. Use text-editing tools only when Skill support or the script is unavailable.",
